...
public class Adapter_cart_list extends RecyclerView.Adapter<Adapter_cart_list.MyViewHolder> {
    ...
    public void addItem(String cartUid) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.ADD_ITEM,
    ...
    public void minusItem(String cartUid) {
        ...
        requestQueue = Volley.newRequestQueue(context);
        // Creating string request with post method.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.MINUS_ITEM,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {
                        // Hiding the progress dialog after all task complete.
    ...
    public void removeItem(String cartUid) {
        ...
        requestQueue = Volley.newRequestQueue(context);
        // Creating string request with post method.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.REMOVE_ITEM,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String ServerResponse) {
                        // Hiding the progress dialog after all task complete.
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView itemName, itemRate, itemPrice, itemQty, addItem, minusItem, removeItem;
        ImageView itemLogo;
