package com.hst.kirteerefinedoil.Utilities;
...
public class Constant {
    ...
    public static final String ADD_CART = domain + "addCart/index.php";
    public static final String CART_LIST = domain + "cartList/index.php";
